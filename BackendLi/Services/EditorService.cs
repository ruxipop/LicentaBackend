...
public class EditorService:IEditorService
{
    ...
    {
        return _repository.GetEntities<EditorChoice>().Where(ec=>ec.EditorId==userId).Include(ec=>ec.Image).ThenInclude(i=>i.Autor).Include(ec=>ec.Image).ThenInclude(l=>l.Likes)
    ...
    public SuccessResponseDto AddImagedToVoted(EditorChoice editorChoice)
    {
        ...
        if (vote != null)
        {
            return new SuccessResponseDto("You have already voted this image!");
